      ...
      <footer id="contact-footer" className="border-t border-gray-800 py-12 mt-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div><div className="text-2xl font-bold mb-4">KeyNotes<span className="text-indigo-400">AI</span></div><p className="text-gray-400 mb-6">AI-powered note summarization and practice exercises.</p><div className="space-y-3 text-gray-400"><div className="flex gap-3"><Mail /> nkananglawrence@gmail.com</div><div className="flex gap-3"><Phone /> +2348076469279</div><div className="flex gap-3"><MapPin /> Abuja, Nigeria</div></div></div>
